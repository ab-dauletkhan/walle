...
from src.face_recognition_system.recognize.pipeline import detect_faces_yolo8, crop_and_align, ArcFaceEmbedder
...
def recognize_image(img_bgr, embedder, conn, threshold=0.8):
...
if __name__ == "__main__":
    ...
    out_vid = cv2.VideoWriter(
        "/home/c504/Desktop/walle_vision/inference_results/Yerzhan_annotated.mp4",
    ...
    while True:
        ...
        out = recognize_image(frame, embedder, conn,threshold=0.8)
        #out_vid.write(frame)                          
