...
if _env_key:
    ...
    _logging.warning("WALLE_SECRET_KEY not set; using random key (sessions won't persist across restarts)")
...
if LOGIN_PASSWORD == 'walle':
    import logging as _logging
    _logging.warning("Using default password 'walle'. Set WALLE_PASSWORD env var for production.")
